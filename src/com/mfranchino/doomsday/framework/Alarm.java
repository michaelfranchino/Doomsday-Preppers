...
public class Alarm {
	...
	public static Alarm createAutoAlarm(String name, AlarmType alarmType, int triggerTimeSeconds ) {
		Alarm alarm = new Alarm(name, alarmType, AlarmTrigger.Automatic, true, triggerTimeSeconds * 1000);
		
		return alarm;
	}
	
	public static Alarm createManualAlarm(String name, AlarmType alarmType) {
		Alarm alarm = new Alarm(name, alarmType, AlarmTrigger.Manual, false, 0);
		
		return alarm;
	}
	
	public static Alarm createExternalAlarm(String name, AlarmType alarmType) {
		Alarm alarm = new Alarm(name, alarmType, AlarmTrigger.External, false, 0);
